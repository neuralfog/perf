        ...
        ? html`<div class="control-panel">
            ...
            <div class="button-wrapper">
              <div>
                ...
                <button class="button-sm" @click=${this.onSignalClick}>
                  ${config.value.signal ? html`ON` : html`OFF`}
                </button>
              </div>
              <div>
                <div class="label">Internal State</div>
                <button class="button-sm" @click=${this.onStateClick}>
                  ${config.value.internalState ? html`ON` : html`OFF`}
                </button>
              </div>
              <div>
                <div class="label">Props</div>
                <button class="button-sm" @click=${this.onPropsClick}>
